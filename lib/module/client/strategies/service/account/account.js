...
const station_1 = require("../../play/nodes/signatures/station/station");
...
class Account extends base_1.Base {
    ...
    async getStation(uuid) {
        ...
        try {
            ...
            if (station instanceof station_1.Station)
                return station;
            throw new Error('UNEXPECTED RESULT');
        }
        catch (e) {
    ...
    async skills(type) {
        return {
            direction: openlib_3.SignalDirection.OUT,
            type: openlib_2.SignalType.SKILLS,
            payload: { type },
            emitter: [],
            catcher: []
        };
...
__decorate([
    base_1.Base.request(openlib_2.SignalType.SKILLS),
    __metadata("design:type", Function),
