...
class Planet extends base_1.NodeBase {
    ...
    async make(type, level) {
        ...
        return {
            type: openlib_2.SignalType.MAKE,
            payload: { type, level },
            emitter: [],
            catcher: [uuid],
            secure: token,
    ...
    async sell(uuid, price) {
        const { token } = this;
        return {
            type: openlib_2.SignalType.OPEN,
    ...
    async close(uuid) {
        const { token } = this;
        return {
            type: openlib_2.SignalType.CLOSE,
            payload: { uuid },
            emitter: [],
            catcher: [this.uuid],
            secure: token,
...
__decorate([
    base_2.Base.request(openlib_2.SignalType.MAKE_SUCCESS),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Number]),
    __metadata("design:returntype", Promise)
], Planet.prototype, "make", null);
__decorate([
    base_2.Base.request(openlib_2.SignalType.OPEN_SUCCESS),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Number]),
    __metadata("design:returntype", Promise)
...
__decorate([
    base_2.Base.request(openlib_2.SignalType.CLOSE_SUCCESS),
    __metadata("design:type", Function),
